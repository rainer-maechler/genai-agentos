#!/usr/bin/env python3
"""
Simple Document Analyzer Agent

This is a working agent that connects to GenAI AgentOS and shows as active.
It demonstrates the document analysis functionality from our showcase.
"""
...
from simple_websocket_agent import DocumentAnalyzerAgent
